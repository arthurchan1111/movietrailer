...
# Instantiate 6 instances of the Movie class
# in media file and added specific attributes for each movie

your_name = media.Movie("Your Name",
                        "A Story of a Boy and Girl Switching Bodies",
                        "https://myanimelist.cdn-dena.com/" +
                        "images/anime/9/77484l.jpg",
...
up = media.Movie("UP", "An Old Man's Adventure",
                 "https://upload.wikimedia.org/wikipedia/" +
                 "en/0/05/Up_%282009_film%29.jpg",
                 "https://www.youtube.com/watch?v=ORFWdXl_zJ4")

spirited_away = media.Movie("Spirited Away",
                            "A Girl's Adventure in a Magical Land",
                            "https://images-na.ssl" +
                            "-images-amazon.com/images/M/" +
                            "MV5BMTk3NTM1NTg1Ml5BMl5Ban" +
                            "BnXkFtZTgwOTgzMTMyMDE@" +
                            "._V1_UY268_CR6,0,182,268_AL_.jpg",
                            "https://www.youtube.com/watch?v=ByXuk9QqQkk")

graveoftheFireFlies = media.Movie(
                                  "Grave of the Fireflies",
                                  "A Young Boy and His Sister's" +
                                  "struggle during the aftermath" +
                                  "of World War 2",
...
gardenofwords = media.Movie("The Garden of Words",
                            "A 15 Year Old Boy's unlikely" +
                            "friendship with a young women",
                            "https://upload.wikimedia.org/wikipedia/" +
                            "en/c/c3/Garden_of_Words_poster.png",
